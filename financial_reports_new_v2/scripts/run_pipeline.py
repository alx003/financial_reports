...
from financial_reports.period_extraction import collect_all_periods, extract_all_series
...
def main() -> None:
    ...
    for company in companies:
        ...
        periods = collect_all_periods(all_series)
        ...
        write_workbook(all_series, periods, ticker, name, xlsx_path)
